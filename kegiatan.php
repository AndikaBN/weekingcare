...
<head>
  ...
  <title>Kegiatan - SDN 1 Sembung</title>
...
<body>
    ...
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="/"><span
          class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><img
            src="assets/img/brands/lambang-tut-wuri-handayani.png" class="img-fluid" alt="" /></span><span>SDN 1
  ...
  <section class="py-5">
    <div class="container py-5">
      ...
      <div
        class="row g-0 row-cols-1 row-cols-md-2 row-cols-xl-3 d-flex align-items-md-center align-items-xl-center justify-content-center">
