    ...
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="/"><span
          class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><img
            src="assets/img/brands/lambang-tut-wuri-handayani.png" class="img-fluid" /></span><span>SDN 1
          Sembung</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span
        ...
        <div class="col-12 col-lg-10 mx-auto">
          <div class="position-relative" style="display: flex; flex-wrap: wrap; justify-content: flex-end">
            <div style="position: relative; flex: 0 0 45%; transform: translate3d(-15%, 35%, 0)"><img class="img-fluid"
                data-bss-parallax="" data-bss-parallax-speed="0.8" src="assets/img/products/3.jpg" /></div>
            <div style="position: relative; flex: 0 0 45%; transform: translate3d(-5%, 20%, 0)"><img class="img-fluid"
                data-bss-parallax="" data-bss-parallax-speed="0.4" src="assets/img/products/2.jpg" /></div>
            <div style="position: relative; flex: 0 0 60%; transform: translate3d(0, 0%, 0)"><img class="img-fluid"
                data-bss-parallax="" data-bss-parallax-speed="0.25" src="assets/img/products/1.jpg" /></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-5">
    <div class="container text-center py-5">
      <p class="mb-4" style="font-size: 40px">
        ...
        Dikenal dan dipercaya oleh <span class="text-success"><strong>puluhan ribu siswa dan orang tua</strong></span>
        untuk penyelenggaraan pendidikan terbaik.
      </p>
    </div>
  </section>
  <section>
    <div id="aboutus" class="container bg-dark py-5">
      <div class="row">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
          <h1 class="fw-bold text-success mb-2">Tentang Kami</h1>
          <h2 class="fw-bold">Apa itu SDN 1 Sembung?</h2>
        </div>
      </div>
      <div class="py-5 p-lg-5">
        <div class="row align-items-center">
          <h3 style="text-align: justify">
            SDN 1 Sembung adalah lembaga pendidikan yang berkomitmen menyediakan layanan pendidikan berkualitas
            untuk
            anak-anak. Kami memberikan pelayanan pendidikan yang mencakup pengembangan karakter, pembelajaran kreatif,
            dan interaksi sosial positif. Dengan staf pengajar yang berdedikasi, SDN 1 Sembung menyediakan
            lingkungan
            belajar yang mendukung pertumbuhan dan perkembangan optimal bagi setiap siswa. Kami percaya bahwa memberikan
            pendidikan yang bermakna adalah kunci untuk menciptakan generasi penerus yang unggul dan berkontribusi
