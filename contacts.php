...
<head>
  ...
  <title>Pendafataran - SDN 1 Sembung</title>
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-xl-6 text-center mx-auto">
          ...
          <h2 class="fw-bold">Peserta didik baru</h2>
        </div>
      </div>
    </div>
  </section>
  <section>
    <div class="container bg-dark " style="width: 70%; height: 830px;">
      <div class="row align-items-center">
        <div class="col-md-6">
          <img src="assets/img/Galeri/KleePortrait.jpg" alt="Klee" class="img-fluid" height="100px" />
        </div>
        <div class="col-md-6" style="margin-bottom: 500px;">
          <h3 class="text-white">Ayo Bergabunglah dengan SDN 1 Sembung supaya anak anda menjadi lebih baik dan menjadi
            anak yang soleh <span class="text-success"><strong>&</strong></span> solehah</h3>
          <br>
          <a class="btn btn-primary shadow" role="button" href="pendaftaran.php">Daftar disini !</a>
        </div>
      </div>
    </div>
  </section>
